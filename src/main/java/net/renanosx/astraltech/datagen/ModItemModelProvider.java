...
//        basicItem(ModBlocks.BISMUTH_DOOR.asItem());
        ...
        handheldItem(ModItems.MINERS_DREAM);
        ...
        trimmedArmorItem(ModItems.ULTIMATE_BOOTS);
        trimmedArmorItem(ModItems.ULTIMATE_CHESTPLATE);
        trimmedArmorItem(ModItems.ULTIMATE_HELMET);
        trimmedArmorItem(ModItems.ULTIMATE_LEGGINGS);
    }

    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = AstralTechMod.MOD_ID; // Change this to your mod id
    ...
    public void buttonItem(DeferredBlock<?> block, DeferredBlock<Block> baseBlock) {
        this.withExistingParent(block.getId().getPath(), mcLoc("block/button_inventory"))
                .texture("texture",  ResourceLocation.fromNamespaceAndPath(AstralTechMod.MOD_ID,
    ...
    public void wallItem(DeferredBlock<?> block, DeferredBlock<Block> baseBlock) {
        this.withExistingParent(block.getId().getPath(), mcLoc("block/wall_inventory"))
                .texture("wall",  ResourceLocation.fromNamespaceAndPath(AstralTechMod.MOD_ID,
                        "block/" + baseBlock.getId().getPath()));
    }
